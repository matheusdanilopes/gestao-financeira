...
import { addMonths, subMonths, format, startOfMonth, parse, isToday, isYesterday, parseISO } from 'date-fns'
...
export default function ComprasPage() {
  ...
  // Agrupa por data efetiva (yyyy-MM-dd), mantendo ordem decrescente
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="text-right shrink-0">
                          ...
                          {isParcelado && (
                            <span className="inline-block mt-0.5 text-[10px] font-semibold bg-amber-100 text-amber-700 px-1.5 py-0.5 rounded-full">
